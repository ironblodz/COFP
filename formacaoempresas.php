...
<html lang="en">
  ...
  <!-- Header End -->
          ...
          >
            <div class="mb-4">
                ...
                <p class="mb-4">
                    ...
                    Com uma experiência de 15 anos o INFO desenvolve conteúdos ajustados para obtenção de resultados máximos, para o desenvolvimento de pessoas e organizações. <br><br>

                    Garantimos em 48 horas um plano de formação à sua medida, ajustado à realidade da sua empresa, de acordo com as necessidades identificadas e condições definidas pelo cliente . <br><br>
                ...
                <p class="mb-4">
                    ...
                    <br>
                    <i class="fa fa-arrow-right text-primary me-2"></i>
                    Plataforma vitalícia que permite acesso à avaliação, certificação e outros recursos utilizados na formação
                    <br>
                    <i class="fa fa-arrow-right text-primary me-2"></i>
    ...
    <div class="container-xxl py-5">
      ...
      <!-- Service End --> 
      <h4> <b>Consulte-nos através dos nossos contactos ou preencha o formulário e a nossa equipa irá preparar o seu Plano de Formação ONLINE.</b></h4> 
